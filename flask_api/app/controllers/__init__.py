from .scQuestionController import bluePrint as scQuestionBluePrint
from .algoQuestionController import bluePrint as algoQuestionBluePrint
...
from .postController import bluePrint as postBluePrint
